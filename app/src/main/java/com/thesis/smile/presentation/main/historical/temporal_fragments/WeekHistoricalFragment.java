...
import static com.thesis.smile.Constants.WEEKLY_GROUP_SPACE;
    ...
    private void initData(Event event) {
        ...
        for (HistoricalDataPoint hdp : list) {
            ...
            barProduction.add(new BarEntry(
                    i++,
                    new float[]{ hack,
                            bought_eem+bought_neighbors, (float) hdp.getTotalProduction()},
                    hdp, false));
       ...
       // setSum.setBarBorderWidth(BORDER_WIDTH);
        ...
        data.groupBars(0f, WEEKLY_GROUP_SPACE, BAR_SPACE);
