...
public class SendTransferRequest extends ApiRequest {
    ...
    public SendTransferRequest(String seed, String address, String value, String message, String tag) {
        this.seed = seed;
    ...
    public SendTransferRequest(String seed, List<String> addresses, String value, String message, String tag) {
        this.seed = seed;
